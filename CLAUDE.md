Here's a CLAUDE.md file scoped to get you through the echo loop reliably. I've written it to be directive where Claude Code tends to drift (hallucinating Photon APIs, over-engineering, jumping ahead) and open-ended where your team needs to make judgment calls.
markdown# Sage — Project Context for Claude Code
